  ...
  return (
    <AdminShell title="Dashboard">
      <div className="cards">
        ...
        <div className="card"><div className="label">User balances</div><div className="value">{formatUsd(bal.rows[0].s, 2)}</div></div>
        ...
        <div className="card"><div className="label">Fraud events (24h)</div><div className="value">{fraud.rows[0].c}</div></div>
      </div>
      <p className="muted">
        Same PostgreSQL as the Telegram bot. Review deposits with the checklist before crediting. Pay withdrawals from the Trust wallet, then mark paid.
      </p>
    </AdminShell>
  );
}
